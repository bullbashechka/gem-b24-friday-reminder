...
const CHECKLIST = [
  ...
  '',
  '☐ Сдвинуть задачи, если не планируется выполнение сегодня + комментарий по каждой',
  '☐ Отработать и закрыть обращения в Коннекте',
  '☐ По оставшимся обращениям в Коннекте создать задачу в Битрикс24',
  '',
  'Напомню в 17:00, если задачи на сегодня ещё останутся.',
].join('\n');
